...
#             frappe.db.set_value('Unit', row.unit, 'status', 'Available') # update the unit status
...
#         for row in self.unit_details:
#            frappe.db.set_value('Unit', row.unit, 'status', 'Rented') # update the unit 
...
#         pass #need to get all units if required as multiple units
